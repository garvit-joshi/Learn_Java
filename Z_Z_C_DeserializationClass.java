...
public class Z_Z_C_DeserializationClass
{
	public static void main(String[] args)throws IOException, ClassNotFoundException
	{
		Emp e = null;
		/*************************************************************************
		We Will Create an object that is null as we will store data from file
		into the object in try block
		*************************************************************************/
        ...
        {    
			...
			ObjectInputStream to read the data from the file and store it in an 
			object using readObject method
			*********************************************************************/
            e = (Emp)in.readObject(); 
			/********************************************************************
			We Will Be Read data with readObject() method and will store it in e
			object of Emp class
			********************************************************************/
            in.close(); 
            file.close();
