...
{
	/********************************************************
	We Are Implementing Serializable Interface with Emp Class 
	Because We want to make this class objects into stream of
	Bytes
	**********************************************************/
	public String name;
...
public class Z_Z_B_SerializationClass
{
	public static void main(String[] args)
	{
		...
		try
		{
			...
			/*****************************************************
			The Above Line Shows That The ByteStream of Emp's Object
			Will be stored in a perticular file given in parentheseis.
			*****************************************************/
			ObjectOutputStream out=new ObjectOutputStream(file1);
			/*****************************************************
			We create an object of ObjectOutputStream with the 
			constructor with a parameter of Object of FileOutputStream
			******************************************************/
			out.writeObject(e);
			/*****************************************************
			The Above Function is Present In ObjectOutputStream
			writeObject will take a parameter of object that we 
			want to write in a file.
			*****************************************************/
			out.close();
			file1.close();
			/*****************************************************
