class Counter
{
	...
	static member exists, even if you create multiple objects of the class, or 
...
public class J_Static
{
    ...
    public static void main(String[ ] args)
	{
		...
		Vehicle.horn();
		/**
		the horn method can be called without creating an object:
...
/**
Another example of static methods are those of the Math class, which is why you can call 
them without creating a Math object.
*/